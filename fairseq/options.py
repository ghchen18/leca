...
def get_training_parser(default_task='translation'):
    ...
    add_generation_args(parser) ## add bleu validation
    return parser
...
def add_dataset_args(parser, train=False, gen=False):
    ...
    parser.add_argument('--use-ptrnet', action='store_true',
                    help='set to use pointer network')
    parser.add_argument('--testclean', action='store_true',
                            help='set to test on clean testset with no constrain')
    group.add_argument('--test-seed', default=1, type=int, metavar='N',
                       help='seed for sampling constraints in test') 
...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--validate-interval-updates', type=int, default=1000, metavar='N',
                       help='validate a checkpoint (and validate) every N updates')
...
def add_generation_args(parser):
    ...
    group.add_argument('--max-len-a', default=2, type=float, metavar='N',
    ...
    group.add_argument('--moses-multi-bleu-path', default=None, type=str,
                       help='output decoding files')
    # fmt: on
    return group
...
def add_interactive_args(parser):
    ...
    group.add_argument('--bpedir', default='-', type=str, 
                       help='code and vocab path for fastBPE')
    group.add_argument('--max-constraints-number', type=int, default=50, metavar='N',
