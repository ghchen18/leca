...
class TranslationTask(FairseqTask):
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        def indexed_dataset(path, dictionary, tgt_dict=None):
            if self.args.raw_text:
                return IndexedRawTextDataset(path, dictionary, tgt_dict=tgt_dict)
        ...
        for dk, data_path in enumerate(data_paths):
            for k in itertools.count():
                ...
                src_datasets.append(indexed_dataset(prefix + src, self.src_dict, tgt_dict=self.tgt_dict))
        ...
        self.datasets[split] = LanguagePairDataset(
            ...
            consnmt=self.args.consnmt, training= (split == 'train'),
            testclean=self.args.testclean, test_seed=self.args.test_seed,
        )
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths):
        return LanguagePairDataset(
            ...
            consnmt=self.args.consnmt, training=False, testclean=True, 
            )
